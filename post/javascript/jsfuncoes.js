...
function storage() {
	...
	function listar() {
		...
		for (var i in TableList) {
			...
			'<td>'+cli.cpf+'</td>' +
			'<td>'+cli.nome+'</td>' +
			'<td><img src="../post/imagens/Editar.png" height="30" width="30" alt = " '+i+' " id="btnEditar" class="btnEditar" title="Editar Dados" />   ' +
			'<img src="../post/imagens/Remover.png" height="30" width="30" alt = " '+i+' " id="btnExcluir" class="btnRemover" title="Remover Dados" />' +
			'</tr>');
			destacarLinha();
			limpar();
		}
